...
The second script is called anc_RFC.py and what it does is that it goes ancestor by ancestor for the various reconstructions (output of previous script), and finds the ancestral ORF with the best RFC score relative to the ORF in the focal species. You run it like this python anc_RFC.py [DIR_NAME] [FOCAL_SPECIES] [NO_OF_RANDOMIZATIONS]  
